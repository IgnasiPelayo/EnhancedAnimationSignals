...
namespace EAS
{
    ...
    public class EASDoublePropertyInspectorDrawer : EASPropertyInspectorDrawer
    {
        ...
        {
            if (double.TryParse(GUIUtility.systemCopyBuffer, System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out double result))
            {
                return result;
            }
